...
const aboutUs =
  "Alex, Ari, Diego and Nika are a team participating " +
  "in at the McHacks10 hackathon! They came together to " +
  ...
  "when Alex was feeling lazy, and didn't want to go to the store. He still " +
  "wanted to make a dish with tzatziki, couscous and onions, but he tried searching " +
